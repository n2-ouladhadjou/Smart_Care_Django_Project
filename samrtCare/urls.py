...
urlpatterns = [
    ...
    path('nurse/', nurse_home, name='nurse_home'), # Nurse page link
    path('appointments/<int:pk>/update_status/', update_appointment_status, name='update_appointment_status'), # Apdate the status of appontement
]